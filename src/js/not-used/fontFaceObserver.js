(function() {
    ...
    var fontASubset = new FontFaceObserver('MuseoSansCyrl', {
        weight: 300
    });
    Promise.all([fontASubset.load()]).then(function () {
        document.documentElement.className += " fonts-stage-1";
        var fontA = new FontFaceObserver('MuseoSansCyrl', {
            weight: 100
        });
        var fontB = new FontFaceObserver('MuseoSansCyrl', {
            weight: 500
        });
        var fontC = new FontFaceObserver('MuseoSansCyrl', {
            weight: 700
        });
        var fontD = new FontFaceObserver('MuseoSansCyrl', {
            weight: 900
        });
